...
export default {
  ...
  // Button
  buttonFontFamily: 'RobotoCondensed_bold',
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#1880b0' : '#1880b0',
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  // Font
  DefaultFontSize: 16,
  fontFamily: platform === PLATFORM.IOS ? 'System' : 'RobotoCondensed',
  fontSizeBase: 15,
  get fontSizeH1() {
  ...
  activeTab: platform === PLATFORM.IOS ? this.brandPrimary : '#fff',
  sTabBarActiveTextColor: this.brandPrimary,
  tabBarActiveTextColor: platform === PLATFORM.IOS ? this.brandPrimary : '#fff',
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : '#3F51B5',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? this.brandPrimary : this.brandPrimary,
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#F8F8F8',
  toolbarHeight: platform === PLATFORM.IOS ? 64 : 56 + Constants.statusBarHeight,
  toolbarSearchIconSize: platform === PLATFORM.IOS ? 20 : 23,
  toolbarInputColor: platform === PLATFORM.IOS ? '#CECDD2' : this.brandPrimary,
  searchBarHeight: platform === PLATFORM.IOS ? 30 : 40,
  searchBarInputHeight: platform === PLATFORM.IOS ? 30 : 50,
  toolbarBtnTextColor: platform === PLATFORM.IOS ? this.brandPrimary : '#000',
  ...
  listItemSelected: platform === PLATFORM.IOS ? this.brandPrimary : '#3F51B5',
  ...
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? this.brandPrimary : '#fff',
  segmentTextColor: platform === PLATFORM.IOS ? this.brandPrimary : '#fff',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : '#3F51B5',
  segmentBorderColor: platform === PLATFORM.IOS ? this.brandPrimary : '#fff',
  ...
  topTabBarActiveTextColor: platform === PLATFORM.IOS ? this.brandPrimary : '#fff',
  topTabBarBorderColor: platform === PLATFORM.IOS ? '#a7a6ab' : '#fff',
  topTabBarActiveBorderColor: platform === PLATFORM.IOS ? this.brandPrimary : '#fff',
  ...
  // Title
  titleFontfamily: 'RobotoCondensed_bold',
